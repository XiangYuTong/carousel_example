...
public class INIParser
{
    ...
    public void Open(string path)
    {
        ...
        {
            Encoding winLatinCodePage = Encoding.GetEncoding("gb2312");//GBK
            m_iniString = File.ReadAllText(m_FileName, winLatinCodePage);
        }
        else
        {
    ...
    private void PerformFlush()
    {
        ...
        try
        {
            ...
            if (m_FileName != null)
            {
                File.WriteAllText(m_FileName, m_iniString,Encoding.Default);
            }
        }
        finally
        {
